...
namespace Sav.Infrastructure.Migrations
{
    ...
    [Migration("20230325180629_AvatarFrameAdded")]
    partial class AvatarFrameAdded
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Sav.Infrastructure.Entities.UserAchievementEntity", b =>
                {
                    ...
                    b.HasOne("Sav.Infrastructure.Entities.UserGameEntity", null)
                        .WithMany("UserAchievements")
                        .HasForeignKey("UserId", "AppID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
