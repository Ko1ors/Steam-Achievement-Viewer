    ...
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            CreateMap<Models.SteamApi.Profile, UserEntity>()
                ...
                .ForMember(dest => dest.AvatarFrame, opt => opt.Ignore())
                .ReverseMap();
            ...
            CreateMap<UserEntity, UserGameEntity>()
                ...
                .ForMember(dest => dest.HoursLast2Weeks, opt => opt.Ignore())
                .ForMember(dest => dest.HoursOnRecord, opt => opt.Ignore())
                .ForMember(dest => dest.AppID, opt => opt.Ignore())
                .ForMember(dest => dest.StatsLink, opt => opt.Ignore())
                .ForMember(dest => dest.User, opt => opt.Ignore())
                .ForMember(dest => dest.Game, opt => opt.Ignore())
                .ForMember(dest => dest.UserAchievements, opt => opt.Ignore())
                .ForSourceMember(src => src.AvatarFrame, opt => opt.DoNotValidate())
                .ReverseMap();
